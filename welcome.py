...
improve web pages visibility by displaying them in an engaging and appealing visual format potentially
 increasing the web page clicks. These rich results are achieved through the use of structured
data. which provides additional context about the content of a web page.""")
    ...
    st.markdown(
        "We used the data published by [Web Data Common](http://webdatacommons.org) that extracted web entities from the [Common Crawl](https://commoncrawl.org/) data.")

    st.write("## Characteristic Sets")
    st.markdown(
        "To sum up the usage data we used [Characteristic Sets](https://ieeexplore.ieee.org/abstract/document/5767868) that can be represented as [upsetplots](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=6876017).")
